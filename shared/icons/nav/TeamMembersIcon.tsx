...
const TeamMembersIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width="18"
      height="18"
    ...
    >
      ...
      />
      <path
        d="M12 2.3457C12.6433 2.51248 13.213 2.88815 13.6198 3.41375C14.0265 3.93935 14.2471 4.58512 14.2471 5.2497C14.2471 5.91429 14.0265 6.56006 13.6198 7.08566C13.213 7.61126 12.6433 7.98693 12 8.1537"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M16.5 15.7502V14.2502C16.4995 13.5855 16.2783 12.9397 15.871 12.4144C15.4638 11.889 14.8936 11.5138 14.25 11.3477"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
